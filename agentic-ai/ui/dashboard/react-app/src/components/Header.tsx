...
export default function Header({ active, onNav, isDark, onToggleDark }: HeaderProps) {
        ...
        <div className="flex items-center justify-between py-3 border-b border-gray-700">
          ...
          <div className="flex items-center gap-4 text-xs text-gray-300">
            ...
            <button
              ...
              className="w-8 h-8 flex items-center justify-center rounded-lg bg-gray-700 hover:bg-gray-600 transition-colors text-base"
            >
              {isDark ? '☀️' : '🌙'}
            </button>
          </div>
