...
if __name__ == "__main__":
    # `make seed` runs this file directly so you can validate DATASET_DIR /
    # DATASET_SOURCES against the mounted CSVs without booting the full
    # stack — construction alone triggers the discovery + summary logging.
    DatasetLoader()